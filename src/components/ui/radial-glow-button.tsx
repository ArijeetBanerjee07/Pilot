  ...
  return (
    <div className="relative inline-block">
      <style>{`
        ...
        @property --rg-color-2 { syntax: '<color>'; initial-value: #2e1065; inherits: false; }
        @property --rg-color-3 { syntax: '<color>'; initial-value: #7e22ce; inherits: false; }
        @property --rg-color-4 { syntax: '<color>'; initial-value: #d8b4fe; inherits: false; }
        @property --rg-color-5 { syntax: '<color>'; initial-value: #000000; inherits: false; }
        @property --rg-border-angle { syntax: '<angle>'; initial-value: 180deg; inherits: true; }
        @property --rg-border-color-1 { syntax: '<color>'; initial-value: hsla(270, 75%, 90%, 0.7); inherits: true; }
        @property --rg-border-color-2 { syntax: '<color>'; initial-value: hsla(270, 50%, 90%, 0.25); inherits: true; }
        ...
        .rg-button {
          ...
          padding: 16px 24px;
          border: none;
          border-radius: 9999px; /* Fully rounded to match V6 */
          font-family: inherit;
          font-size: 16px;
        ...
        .rg-button:hover {
          ...
          --rg-border-color-1: hsla(270, 75%, 90%, 0.1);
          --rg-border-color-2: hsla(270, 50%, 90%, 0.35);
      ...
      <button className={cn("rg-button shadow-lg", className)} type="button" {...props}>
        <span className="rg-shine">
          <span></span>
        </span>
        <span className="rg-bg"></span>
        <span className="rg-label flex items-center gap-2 justify-center">{children}</span>
      </button>
    </div>
  );
}
